...
<xsl:stylesheet version="2.0"
    ...
    <!-- Adapted from https://github.com/pedroborges/xml-sitemap-stylesheet/blob/48c997dab2f8619d45d8d2b7a13f8597d951939e/sitemap.xsl -->
    ...
    <xsl:template match="/">
        <html>
            <head>
                ...
                <link rel="stylesheet" href="{{- "/assets/css/tachyons@4.6.1/tachyons.min.css" | absolute_url -}}"/>
            </head>
            <body class="ph3 pb3 mid-gray">
                ...
                <footer class="mw8 center pv4 tc">
                    This XSL stylesheet is adapted from the open-source
                    <a href="https://github.com/pedroborges/xml-sitemap-stylesheet" title="Go to GitHub" class="link blue">XML Sitemap Stylesheet</a> created by
                    <a href="https://pedroborg.es" title="Pedro Borges" class="link blue">pedroborg.es</a>.
                </footer>
            </body>
        </html>
    </xsl:template>
