...
I love static things. [No JavaScript is required for browsing my posts.]({% link _posts/2025-06-17-csmantle-top-javascript-usage.md %}) Animations are pure <abbr title="Cascading Stylesheet">CSS</abbr> and limited to the minimum. This site, same as most of my web apps, is statically generated and served. Your browser is not burdened with excessive <abbr title="Document Object Model">DOM</abbr> manipulation (which is often abused by React and other frameworks). This means you can freely [`curl`](https://curl.se/) my site without worrying about any dynamic rendering complexities, as long as you respect the license shown at the bottom.
